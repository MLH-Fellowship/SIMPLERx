...
class WriteNewPres extends React.Component{
    ...
    render(){
        ...
        <form className="form" onSubmit={this.handleSubmit} onChange={this.handleChange}>
            <label htmlFor="Name" style={{marginRight:"70px"}}>Name </label>
            
            <input type="text" name="Name" id="Name" style={{marginRight:"60px"}}></input>
            
            <label htmlFor="Aadhar" style={{marginRight:"36px"}}>Aadhar </label>
            
            <input type="text" name="Aadhar" id="Aadhar"></input>
            <br/><br/>
            <label htmlFor="Email" style={{marginRight:"55px"}}>Email ID </label>
            
            <input type="email" name="Email" style={{marginRight:"60px"}}></input>
